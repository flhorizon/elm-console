...
putChar : Char -> IO ()
putChar c =
    Impure (PutS (String.cons c "") (\_ -> Pure ()))
            ...
            getChar
                >>= \c ->
                        if c == end then
                            ...
                            go (String.append s (String.cons c ""))
    in
        go ""
...
andThen io f =
    case io of
        ...
        Impure iof ->
            Impure (mapF (flip andThen f) iof)
